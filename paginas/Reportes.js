...
function Reportes() {
  ...
  const items = [
    { control: '00001', equipo: 'LAPTOP', marca: 'LENOVO', serie: '11111111', cantidad: 1, responsable: 'FULANO1', ubicacion: 'Edificio E1, Salon 202', descripcion: 'Equipo portátil, Procesador Intel core 5, 256 GB, 8 GB RAM, 2.70 Hz' },
    { control: '00002', equipo: 'DESKTOP', marca: 'DELL', serie: '22222222', cantidad: 1, responsable: 'FULANO2', ubicacion: 'Edificio E1, Salon 203', descripcion: 'Equipo de escritorio, Procesador Intel core i7, 512 GB, 16 GB RAM, 3.20 Hz' },
    { control: '00003', equipo: 'IMPRESORA', marca: 'HP', serie: '33333333', cantidad: 2, responsable: 'FULANO3', ubicacion: 'Edificio E2, Salon 101', descripcion: 'Impresora láser, 1200 dpi, 20 ppm' },
    { control: '00004', equipo: 'PROYECTOR', marca: 'EPSON', serie: '44444444', cantidad: 1, responsable: 'FULANO4', ubicacion: 'Edificio E2, Salon 102', descripcion: 'Proyector HD, 3000 lúmenes, 1080p' },
    { control: '00005', equipo: 'TABLET', marca: 'SAMSUNG', serie: '55555555', cantidad: 5, responsable: 'FULANO5', ubicacion: 'Edificio E3, Salon 201', descripcion: 'Tablet, 10 pulgadas, 64 GB, 4 GB RAM' }
  ];
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.navbar}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('Faltante')}
        >
          <Text style={styles.navButtonText}>Faltante</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.navButton}
          onPress={() => navigation.navigate('Discrepancias')}
        >
